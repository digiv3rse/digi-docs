...
- **No Protocol Fee** - DIGI doesn't take a cut of the final sale amount
...
You can read more about the latest version of the `Asks Module` [here](/docs/smart-contracts/modules/Asks/digi-v3-asks-intro).

---

### Approving Tokens to DIGI
:::note 
Before getting started with the `Asks Module`, we **strongly** recommend that you check out our guide on how to [approve tokens to DIGI V3](/docs/guides/v3-approvals). 
:::

TLDR, DIGI V3 requires that a user approves their assets to a Transfer Helper contract as well as approve the `Asks v1.1 Module` in the Module Manager contract.
