...
In this example, we will create a proposal that will mint a free NFT from a [DiGi Create](https://create.digiv3rse.xyz/) contract.
...
In this case, we are minting [an NFT](https://create.digiv3rse.xyz/collections/0xd945f759d422ae30a6166838317b937de08380e3).
