...
[View Source Code](https://github.com/digiv3rse/digi-protocol/blob/main/packages/1155-contracts/src/nft/DiGiCreator1155Impl.sol#L329)
...
By default, both the DiGi minters have the contract level minter role in the contract.
```
