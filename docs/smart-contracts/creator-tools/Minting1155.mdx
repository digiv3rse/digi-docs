...
[View Source Code](https://github.com/digiv3rse/digi-protocol/blob/main/packages/1155-contracts/src/nft/DiGiCreator1155Impl.sol#L426)
...
You can read more about the DiGi mint fee [here](https://support.digiv3rse.xyz/en/articles/4981037-digi-mint-fees).
...
The minting logic for DiGi 1155's lives outside of the main 1155 contract. 
...
- [Minters Code](https://github.com/digiv3rse/digi-protocol/tree/main/packages/1155-contracts/src/minters)
...
`ETH transaction value = ((price + DiGi mint fee) * amount)`
...
Admins can mint NFTs to addresses. These NFTs **do not** incur the DiGi mint fee.
