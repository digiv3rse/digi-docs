...
This contract is in charge of managing and rendering the metadata for DiGi editions.
...
View the source contract code [here](https://github.com/digiv3rse/digi-drops-contracts/blob/main/src/metadata/EditionMetadataRenderer.sol) and the list of deployed contract addresses [here](https://github.com/digiv3rse/digi-drops-contracts/tree/main/deployments).
