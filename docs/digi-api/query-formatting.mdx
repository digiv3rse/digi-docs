...
:::note
Check out our [GraphiQL](https://api.digiv3rse.xyz/graphql) to play around with the API
:::
...
- `sales`: Historical sales data from DIGI, OpenSea, LooksRare, Foundation, and more.
