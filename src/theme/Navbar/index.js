    ...
    <div className="navbar-sidebar">
      ...
      >
        <div className="navbar-sidebar__item menu">
          ...
          <a href="https://digiv3rse.xyz/" target="_blank" rel="noopener noreferrer">
            <p className={styles.digiCoText}>DiGi.co</p>
          </a>
          <a
            href="https://github.com/digiv3rse"
            target="_blank"
        ...
        {!mobileSidebar.shouldRender && (
          <>
            <div className="navbar__items navbar__items--right">
              ...
              <a href="https://digiv3rse.xyz/" target="_blank" rel="noopener noreferrer">
                <button className={styles.digiCoButton}>DiGi.co</button>
              </a>
            </div>
          </>
        )}
